		...
		try {
			...
			for (int i = 0; i < userCount; i++) {
				...
				User user = new User(userName, userWarehouseID, userDistrictID,
						...
						deliveryPercent, stockLevelPercent, warehouseCount,
						this, newOrderThinkSecond, paymentThinkSecond,
						orderStatusThinkSecond, deliveryThinkSecond,
						stockLevelThinkSecond, databaseType, printStreamErrors);
